...
/* eslint-disable @style/max-len,vue/first-attribute-linebreak,vue/max-attributes-per-line */
</script>

<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 53.3"><path fill="#100f0d" d="M173.3 53.3H6.7c-3.7 0-6.7-3-6.7-6.6v-40C0 3 3 0 6.7 0h166.6c3.7 0 6.7 3 6.7 6.7v40c0 3.6-3 6.6-6.7 6.6" />
    <path fill="#a2a2a1"
    ...
    />
    <path fill="#eb3131" d="m27.6 25.9-14.2 15a3.8 3.8 0 0 0 5.7 2.4l16-9.3-7.5-8.1" />
    <path fill="#f6b60b" d="m42 23.3-7-4-7.7 7 7.8 7.7 6.9-4a3.8 3.8 0 0 0 0-6.7" />
    <path fill="#5778c5" d="m13.4 12.4-.1 1V40l.1 1 14.7-14.7-14.7-14" />
    <path fill="#3bad49" d="m27.7 26.7 7.4-7.4-16-9.2a3.8 3.8 0 0 0-5.7 2.3l14.3 14.3" />
    <path fill="#fff" stroke="#fff" stroke-miterlimit="10" stroke-width=".3"
