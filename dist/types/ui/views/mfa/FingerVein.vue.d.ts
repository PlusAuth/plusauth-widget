declare const _default: import("vue").DefineComponent<{
    fields: {
        type: () => import("../../interfaces").AdditionalFields;
        default: () => import("../../interfaces").AdditionalFields;
    };
    ...
    loadingMsg: import("vue").Ref<string | null>;
    selectedFinger: import("vue").Ref<number>;
    deviceOk: import("vue").Ref<boolean>;
    context: any;
    ...
    onFingerSelect(ind: number, hand: 'left' | 'right'): Promise<void>;
    submit(): Promise<void>;
    ...
    fields: import("../../interfaces").AdditionalFields;
